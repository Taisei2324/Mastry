...
window.MASTRY_FRAMES = {
  ...
  baseM:   "frames/",     // mobile tier now ALSO the full 1080p frames (user chose max quality);
                          //   memory is bounded per-tier in scrubber.js so the phone streams a
                          //   small decoded window instead of holding the whole 1080p reel.
  ext:     "webp",
  count:   505,           // frames actually produced (all 505 kept; 1080p, ~15.0 MB)
  pad:     4,             // zero-pad width -> "0001"
  width:   1920, height: 1080,     // desktop frame pixel dims (full 1080p)
  widthM:  1920, heightM: 1080,    // mobile tier is the same 1080p frames now
