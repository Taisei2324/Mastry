...
window.MASTRY_FRAMES = {
  ...
  ext:     "webp",
  count:   505,           // frames actually produced (all 505 kept; desktop tier 8.94 MB, under guardrail)
  pad:     4,             // zero-pad width -> "0001"
  width:   1280, height: 720,      // desktop frame pixel dims
  widthM:  960,  heightM: 540,     // mobile frame pixel dims
  poster:  "poster.jpg",  // full-quality late-Greek still (1600x900 q90) for OG + no-JS fallback
  ...
  totalBytes: 9371440     // desktop tier total bytes (report/preload budgeting)
};
