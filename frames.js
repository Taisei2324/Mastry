...
window.MASTRY_FRAMES = {
  base:    "frames/",       // full 1080p tier — the default (fast connections), ~17 MB
  baseLow: "frames-720/",   // lighter 1280x720 tier (~10 MB), loaded ONLY on SLOW connections
                            //   (data-saver / 2g / 3g / weak 4g) so the hero still arrives fast.
                            //   scrubber.js picks resolution by connection, memory-bounding by
                            //   viewport. iOS (no Network Information API) -> 1080p default.
  ext:     "webp",
  count:   505,             // all 505 frames kept
  pad:     4,               // zero-pad width -> "0001"
  width:   1920, height: 1080,     // 1080p tier pixel dims (engine cover-fits to natural size)
